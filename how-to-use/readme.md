...
If you'd prefer to just watch the videos, you can see them [all together here](https://vimeo.com/user/1116072/folder/28575750). Also, don't miss the very last page here: [Sample Animations](sample-animations), which shows graphs for many kinds of animations.
...
- [Introducing Keyframe Toolbox](introducing-keyframe-toolbox)
  - Keyframe graphs control Opacity, Position X & Y, Scale, Rotations, and blur. Horizontal = time, vertical = value. 

- [Preparing still images](preparing-still-images)
