...
## Manipulating keyframes and handles
...
- Control-click on the first keyframe to copy the value of the second keyframe.
- Control-click on the last keyframe to copy the value of second-last keyframe.
...
- Clicking a keyframe selects it. Shift-clicking additional keyframes selects additional keyframes.
- Drag from empty space to create a selection marquee that encloses keyframes to select them.
...
- The menu next to the each graph's reset button enables some advanced features.
