...
**Keyframe Toolbox** will be a one-time payment of **USD$19.99** on the **Mac App Store** (subject to change prior to release).
...
You can use **Keyframe Toolbox** to "unlock" CommandPost! 🥳
